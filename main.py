...
if __name__ == '__main__':
    ...
    print(curr_time)
    filename = shujuji + mymodel + 'Lcl' + str(args.ssl_reg) + '温' + str(args.temp)
    ...
    *********************************************************
    ...
    """
    #row=[交互用户|交互项目[i]+29601]
    #col=[29601+交互项目[i]|交互用户]
    #data=[1,1,1,1,1,...,1]
    ...
    *********************************************************
    ...
    module_name = f"baseline.{mymodel}.py"  # 构建模块名
    f_name = mymodel  # 要调用的函数名
